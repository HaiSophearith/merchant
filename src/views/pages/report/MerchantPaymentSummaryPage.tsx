...
import MerchantPaymentSummaryList from "../../../ui-component/listCollection/MerchantPaymentSummaryList";
import useQueryMerchantPaymentSummary from "../../../hooks/useQueryMerchantPaymentSummary";

const MerchantPaymentSummaryPage = () => {
    ...
    const {merchantPaymentSummaries, total} = useQueryMerchantPaymentSummary({
        pageNumber: page,
        limit: rowsPerPage,
        ...
        <>
            ...
            <Box sx={{ padding: "24px", paddingTop: "0" }}>
                ...
                >
                    ...
                    <MerchantPaymentSummaryList merchantPaymentSummaries={merchantPaymentSummaries}
                    />
                    <TablePagination
                        component="div"
                        count={total}
...
export default MerchantPaymentSummaryPage;