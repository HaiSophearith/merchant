...
import useQueryMerchantReferral from "../../../hooks/useQueryMerchantReferral";
import MerchantReferralList from "../../../ui-component/listCollection/MerchantReferralList";

const MerchantReferralPage = () => {
    ...
    const {merchantReferralItems, total} = useQueryMerchantReferral({
        pageNumber: page,
        limit: rowsPerPage,
...
export default MerchantReferralPage;