...
import MerchantReferralList from "../../../ui-component/listCollection/MerchantReferralList";
import useQueryMerchantReferralByStaff from "../../../hooks/useQueryMerchantReferralByStaff";

const MerchantReferralByStaffPage = () => {
    ...
    const {merchantReferralItems, total} = useQueryMerchantReferralByStaff({
        pageNumber: page,
        limit: rowsPerPage,
        ...
        <>
            ...
            <Box sx={{padding: "24px", paddingTop: "0"}}>
                ...
                >
                    ...
                    <MerchantReferralList merchantReferralItems={merchantReferralItems}/>
                    <TablePagination
                        component="div"
                        count={total}
                        page={page}
...
export default MerchantReferralByStaffPage;