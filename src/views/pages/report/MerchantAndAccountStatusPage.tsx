...
import useQueryMerchantAndAccountStatus from "../../../hooks/useQueryMerchantAndAccountStatus";
...
import MerchantAndAccountStatusList from "../../../ui-component/listCollection/MerchantAndAccountStatusList";
import useQueryBranches from "../../../hooks/useQueryBranches";
import useQueryRegionals from "../../../hooks/useQueryRegionals";

const MerchantAndAccountStatusPage = () => {
    ...
    const {merchantAndAccountStatus, total} = useQueryMerchantAndAccountStatus({
        pageNumber: page,
        limit: rowsPerPage,
...
export default MerchantAndAccountStatusPage;